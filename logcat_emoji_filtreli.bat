@echo off
echo ========================================
echo Logcat Kaydedici - Emoji Loglar
echo ========================================
echo.
...
echo.
echo Logcat kaydediliyor (emoji loglar)...
echo Dosya: player_logs_emoji.txt
echo.
...
REM Logları kaydet
"%ADB_PATH%" logcat | findstr /C:"🎬" /C:"🎮" /C:"📱" /C:"🎛️" /C:"▶️" /C:"⏸️" /C:"✅" /C:"❌" /C:"🔍" /C:"📺" /C:"⏩" /C:"⏪" > player_logs_emoji.txt
