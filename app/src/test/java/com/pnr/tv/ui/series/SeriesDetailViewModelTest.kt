...
class SeriesDetailViewModelTest {
     ...
     */
    @Test
    fun `loadSeries should update series, seasons and episodes on success`() = runTest {
        // Given
        val seriesId = 123
     ...
     */
    @Test
    fun `loadSeries should parse cleanTitle correctly from episode title`() = runTest {
        // Given
        val seriesId = 123
        val mockSeriesInfo = createMockSeriesInfo()
        whenever(mockContentRepository.getSeriesInfo(seriesId))
     ...
     */
    @Test
    fun `selectSeason should update episodes with correct season episodes`() = runTest {
        // Given
        val seriesId = 123
        val mockSeriesInfo = createMockSeriesInfo()
        whenever(mockContentRepository.getSeriesInfo(seriesId))
     ...
     */
    @Test
    fun `loadSeries should emit error when repository returns Error`() = runTest {
        // Given
        val seriesId = 123
     ...
     */
    @Test
    fun `loadSeries should update loading state correctly`() = runTest {
        // Given
        val seriesId = 123
        val mockSeriesInfo = createMockSeriesInfo()
        whenever(mockContentRepository.getSeriesInfo(seriesId))
     ...
     */
    @Test
    fun `loadSeries should emit error and stop loading on exception`() = runTest {
        // Given
        val seriesId = 123
        whenever(mockContentRepository.getSeriesInfo(seriesId))
     ...
     */
    @Test
    fun `getEpisodeStreamUrl should return correct URL format`() = runTest {
        // Given
        viewModel = createViewModel()
     ...
     */
    @Test
    fun `loadSeries should fetch TMDB details when tmdbId is available`() = runTest {
        // Given
        val seriesId = 123
        val mockSeriesInfo = createMockSeriesInfo()
        val mockTmdbDetails = TmdbTvShowDetailsDto(
            id = 1396,
            name = "Breaking Bad",
     ...
     */
    @Test
    fun `loadSeries should handle empty episodes list gracefully`() = runTest {
        // Given
        val seriesId = 123
        val emptySeriesInfo = SeriesInfoDto(
            seasons = emptyList(),
            episodes = emptyMap(),
            info = SeriesDetailInfoDto(
                name = "Empty Series",
                coverUrl = null,
                plot = null,
                cast = null,
