...
class MovieDetailViewModelTest {
    ...
    @Test
    fun `loadMovie should set Loading state initially`() = runTest {
        // Given
        val movieId = 123
    ...
    @Test
    fun `loadMovie should set Success state when movie found`() = runTest {
        // Given
        val movieId = 123
        val testMovie = MovieEntity(
            streamId = movieId,
    ...
    @Test
    fun `loadMovie should set Error state when movie not found`() = runTest {
        // Given
        val movieId = 999
    ...
    @Test
    fun `loadMovie should fetch TMDB details when tmdbId exists`() = runTest {
        // Given
        val movieId = 123
        val tmdbId = 456
        val testMovie = MovieEntity(
    ...
    @Test
    fun `loadMovie should search by title when tmdbId is null`() = runTest {
        // Given
        val movieId = 123
        val testMovie = MovieEntity(
            streamId = movieId,
    ...
    @Test
    fun `addToFavorites should show viewer selection dialog`() = runTest {
        // Given
        val movieId = 123
        val testMovie = MovieEntity(
            streamId = movieId,
