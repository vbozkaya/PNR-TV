...
class BuildLiveStreamUrlUseCaseTest {
    ...
    @Test
    fun `invoke should return correct URL when user exists`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should normalize DNS URL correctly`() =
        runTest {
    ...
    @Test
    fun `invoke should handle DNS with trailing slash`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should handle HTTPS DNS`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should return null when user is null`() =
        runTest {
            // Given
            val channel =
                LiveStreamEntity(
    ...
    @Test
    fun `invoke should handle special characters in username and password`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should handle empty stream ID`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should handle long stream ID`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should handle IP address as DNS`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
    ...
    @Test
    fun `invoke should handle DNS with port number`() =
        runTest {
            // Given
            val user =
                UserAccountEntity(
