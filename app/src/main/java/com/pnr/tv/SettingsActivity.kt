...
class SettingsActivity : BaseActivity() {
    ...
    private fun showLanguageSelectionDialog() {
        ...
        val adapter =
            object : RecyclerView.Adapter<LanguageAdapter.LanguageViewHolder>() {
                ...
                override fun onBindViewHolder(
                    holder: LanguageAdapter.LanguageViewHolder,
                    position: Int,
                ) {
                    ...
                    lifecycleScope.launch {
                        try {
                            ...
                            Toast.makeText(
                                ...
                                getString(R.string.error_with_message, e.message ?: getString(R.string.error_unknown)),
                                Toast.LENGTH_LONG,
                            ).show()
                        }
                    }
