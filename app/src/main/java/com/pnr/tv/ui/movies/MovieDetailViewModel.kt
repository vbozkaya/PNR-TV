...
class MovieDetailViewModel
    ...
    constructor(
        ...
        fun loadMovie(movieId: Int) {
            viewModelScope.launch {
                try {
                    ...
                    val tmdbMovie = if (foundMovie.tmdbId != null) {
         ...
         */
        suspend fun getDirector(tmdbId: Int?, tmdbDetails: TmdbMovieDetailsDto?): String? {
         ...
         */
        suspend fun getCast(tmdbId: Int?, tmdbDetails: TmdbMovieDetailsDto?): String? {
         ...
         * Cache'den veya DTO'dan alır
         */
        suspend fun getOverview(tmdbId: Int?, tmdbDetails: TmdbMovieDetailsDto?): String? {
            val tmdbOverview = if (tmdbId != null) {
